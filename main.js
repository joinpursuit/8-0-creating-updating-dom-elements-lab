...
// array of all articles in under the class .posts
const allArticles = document.querySelectorAll(".posts article")
// select the second post
const secondArticle = allArticles[1]
// use the method .prepend to move the second article so that it is the first article
document.querySelector(".posts").prepend(secondArticle)